...
namespace MvcTurbine.LogReportingDashboard.Helpers
{
    ...
    /// </summary>
    internal class FuzzyDateTime
    {
        private static readonly List<string> dayList = new List<string> {"sun", "mon", "tue", "wed", "thu", "fri", "sat"};

        private static readonly List<IDateTimePattern> parsers = new List<IDateTimePattern>
                                                                     {
                                                                         ...
                                                                         new RegexDateTimePattern(
                                                                             @"next +month",
                                                                             delegate { return DateTime.Now.AddMonths(1); }
                                                                             ),
                                                                         new RegexDateTimePattern(
                                                                             @"next +([2-9]\d*) +days",
                                                                             delegate(Match m)
                                                                         ...
                                                                         new RegexDateTimePattern(
                                                                             @"yesterday",
                                                                             delegate { return DateTime.Now.AddDays(-1); }
                                                                             ),
                                                                         new RegexDateTimePattern(
    ...
    internal interface IDateTimePattern
    {
        DateTime Parse(string text);
    }

    internal class RegexDateTimePattern : IDateTimePattern
    {
