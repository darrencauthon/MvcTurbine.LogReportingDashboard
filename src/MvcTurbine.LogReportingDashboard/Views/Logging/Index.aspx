        ...
        <div class="grid-results">
            <div class="inner">
                ...
                <span style="float: right">
                    Show <%= Html.DropDownList("PageSize", new SelectList(MvcTurbine.LogReportingDashboard.Helpers.FormsHelper.PagingPageSizes, "Value", "Text"), new { onchange = "document.getElementById('myform').submit()" })%> results per page
                </span>
