...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
        ...
        <div class="grid-results">
            <div class="inner">
                ...
                <span style="float: right">
                    Show <%=Html.DropDownList("PageSize", new SelectList(FormsHelper.PagingPageSizes, "Value", "Text"), new {onchange = "document.getElementById('myform').submit()"})%> results per page
                </span>
    ...
    <%
        ...
        <tr class="<%=i++%2 == 1 ? "alt" : ""%>">
            <td>                
                <%=Html.ActionLink("Details", "Details", new {id = item.Id, loggerProviderName = item.LoggerProviderName})%>              
            </td>
            <td>
                <%=i.ToString()%>
            </td>
